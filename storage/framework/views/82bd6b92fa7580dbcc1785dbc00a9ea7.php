        ...
        <div class="container mx-auto">
            <div class="relative -mx-4 flex items-center justify-center sm:justify-between">
                <div class="w-64 max-w-full px-4 sm:w-60 lg:w-48">
                    <a href="<?php echo e(route('customer.index')); ?>" class="block w-full py-5 lg:py-3">
                        <img src="<?php echo e(asset('assets/images/logo-sm.png')); ?>" alt="logo"
                ...
                focus:bg-none focus:ring-0 dark:focus:ring-0 md:me-0"
                                ...
                                <img class="h-8 w-8 rounded-full"
                                    src="<?php echo e(asset('/assets/images/users/avatar-10.png')); ?>" alt="user photo" />
                                    ...
                                    <a href="<?php echo e(route('customer.wishlistAll')); ?>"
                                        ...
                                        <?php if(session()->has('wishlist')): ?>
                                            <span
                                                ...
                                                <?php echo e(count(session('wishlist'))); ?>
...
<?php /**PATH /home/haseeb/What Else/AdminPanel/resources/views/components/customer-layout/navbar.blade.php ENDPATH**/ ?>