        ...
        <div class="order-1 ltr:ms-auto rtl:ms-0 rtl:me-auto flex items-center md:order-2">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="flex">
                                    <img class="object-cover rounded-full h-8 w-8 shrink-0 me-3"
                                        src="<?php echo e(asset('assets/images/users/avatar-3.png')); ?>" alt="logo" />
                                    <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                                        <p
                                            class="text-sm font-medium text-gray-900 truncate
                                dark:text-gray-300">
            ...
            <div class="me-2  dropdown relative">
                <button type="button"
                    ...
                    <img class="h-8 w-8 rounded-full" src="<?php echo e(asset('assets/images/users/avatar-1.png')); ?>"
                        alt="user photo" />
                    <span class="ltr:ms-2 rtl:ms-0 rtl:me-2 hidden text-left xl:block">
                        <span
                            class="block font-medium text-slate-600 dark:text-gray-300"><?php echo e(auth()->user()->name); ?></span>
...
<?php /**PATH /home/haseeb/What Else/AdminPanel/resources/views/components/admin-layout/navbar.blade.php ENDPATH**/ ?>