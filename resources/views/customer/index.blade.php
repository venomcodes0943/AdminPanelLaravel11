                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex-auto p-4">
                                        <div>
                                            <span class="bg-yellow-500 text-gray-900 p-2 rounded">Free
                                            ...
                                            <p class="text-2xl text-slate-800 mb-10">Introduced a new model
                                ...
                                <div
                                    ...
                                    <div class="flex-auto p-4 pb-0">
                                        <h4 class="text-4xl text-slate-800 font-semibold mb-0 font-spartan">
                                            Shoes Collection!</h4>
                                        <p class="text-slate-600 text-2xl mb-3 font-spartan">Launch Offer
                                            15% Off!</p>
                                        <button type="button"
                                ...
                                <div
                                    ...
                                    <div class="flex-auto p-4">
                                        <h4 class="text-2xl text-slate-700 font-semibold mb-0">Most Populer
                                            Brands</h4>
                                        <p class="text-slate-500 text-lg mb-3">All brand Offer start 25
                                            Dec.</p>
                                    </div><!--end card-body-->
                                </div><!--end col-->
                                <div
                        ...
                        <div
                            ...
                            <div class="flex-auto  text-center">
                                ...
                                <div class="flex-auto  text-center p-4">
                                    <span
                                        class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">{{ $product->category->categoryName }}</span>
                                    <a href="ecommerce-product-detail.html"
                                        class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">{{ $product->title }}</a>
                                    <?php
                                    $numStars = rand(2, 5);
                                    $rating = ($numStars / 5) * 5;
                                    echo '<div class="mb-4">';
